""" 
  This script will read the suggestion dictonary and and filetocorrect.txt 
  it will replace the words inside filetocorrect based on dictonary 
"""
...
try:
    ...
    with open('corrected_text.txt', 'w') as file2:
